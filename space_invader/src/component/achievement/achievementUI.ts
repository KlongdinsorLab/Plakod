export class AchievementUI {
	...
	create(): void {
		...
		this.achievementImage.setDisplaySize(
			this.achievementSize.width,
			this.achievementSize.height,
		)
	...
	setLockedAchievement(): void {
		...
		this.lockedImage.setDisplaySize(
			this.achievementSize.width,
			this.achievementSize.height,
		)
		this.lockedImage.setOrigin(0).setTint(0x000000).setAlpha(0.5)
	}
	show(): void {
