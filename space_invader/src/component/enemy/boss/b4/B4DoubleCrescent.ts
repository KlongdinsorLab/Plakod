...
export default class B4DoubleCrescent {
	...
	create(
		...
		this.enemy1 = this.scene.physics.add.image(x + 75, y, 'b4v1', 'b4_skill1.png').setOrigin(0.5,0.5)
        ...
        this.enemy2 = this.scene.physics.add.image(x - 75, y, 'b4v1', 'b4_skill1.png').setOrigin(0.5,0.5)
