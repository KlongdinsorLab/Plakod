...
export default class airflowBox {
	...
	constructor(scene: Phaser.Scene) {
		...
		this.airflowBox
			.setInteractive(
				new Phaser.Geom.Rectangle(width / 2 - 164, 920, 328, 56),
		...
		this.airflowText = scene.add
			.text(width / 2, 920 + 28, this.airflowNumber.toString())
			.setFontSize(32)
			.setColor('#57453B')
			.setOrigin(0.5, 0.5)
	}
