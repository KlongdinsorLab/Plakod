...
export default class InstructionScene extends Phaser.Scene {
	...
	create() {
		...
		this.add
			.image(width / 2, 64, 'icon', 'icon_guidebook.png')
			.setOrigin(0.5, 0)
			.setScale(3, 3)

		this.add
			.image(width / 2, 168, 'heading_spritesheet', 'heading_red.png')
			.setOrigin(0.5, 0)

		const headingText = i18n
			.createTranslatedText(this, width / 2, 172, 'instruction_heading')
			.setOrigin(0.5, 0)
			.setFontSize(42)
			.setStroke('#9E461B', 12)
