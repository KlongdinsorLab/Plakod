...
export default class SettingScene extends Phaser.Scene {
	...
	preload() {
		...
		this.load.atlas(
			'sheet',
			'assets/setting/setting_spritesheet.png',
			'assets/setting/setting_spritesheet.json',
		)
		this.load.atlas(
			'icon',
	...
	create() {
		...
		// Headings
		this.add
			.image(width / 2, MARGIN, 'sheet', 'logo_heading_setting.png')
			.setOrigin(0.5, 0)
		this.add
			.image(width / 2, 169, 'sheet', 'heading_setting.png')
			.setOrigin(0.5, 0)
		this.headingText = i18n
			.createTranslatedText(this, width / 2, 190 - 20, 'setting_title')
			.setFontSize(42)
			.setColor('#FFFFFF')
			.setStroke('#9E461B', 6)
		...
		// Character Select
		this.characterSelectUi = new characterSelectUi(
			this,
			this.usingCharacterId,
			this.characterId,
		)
		...
		// Airflow Text
		this.add
			.image(216, 816, 'sheet', 'logo_setting_airflow.png')
			.setOrigin(0, 0) // Icon
		this.airflowEditText = i18n
			.createTranslatedText(this, 216 + 59 + 13, 816 - 13, 'airflow_volume')
			.setFontSize(32)
			.setPadding(0, 20, 0, 10)
			.setColor('#57453B')
			.setOrigin(0, 0)

		this.medicalAdviceText = i18n
			.createTranslatedText(this, width / 2, 872 - 20, 'doctor_advice_airflow')
			.setFontSize(28)
			.setPadding(0, 20, 0, 10)
			.setColor('#D35E24')
			.setOrigin(0.5, 0)
		...
		// Difficulty
		this.add
			.image(216, 1024, 'sheet', 'logo_setting_difficulty.png')
			.setOrigin(0, 0)
		this.difficultyText = i18n
			.createTranslatedText(this, 216 + 59 + 13, 1024 - 13, 'difficulty_title')
			.setPadding(0, 20, 0, 10)
			.setFontSize(32)
			.setColor('#57453B')
			.setOrigin(0, 0)
