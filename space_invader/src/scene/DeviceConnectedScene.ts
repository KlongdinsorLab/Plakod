...
export default class DeviceConnectedScene extends Phaser.Scene {
	...
	popUp1(): void {
		// Connecting
		logger.debug(this.scene.key, 'Device Connecting Instruction')
	}

	popUp2(): void {
		// Closing
		logger.debug(this.scene.key, 'Device Closing Instruction')
	}

	popUp3(): void {
		// Charging
		logger.debug(this.scene.key, 'Device Charging Instruction')
	}
}
